...
export default function Detail(){
   ...
   const message=`Olá ${incident.name}, estou tentando ${Intl.NumberFormat('pt-AO',
   {style:'currency',currency:'AOA'}).format(incident.value)}`;
   ...
   function sendWhatsapp(){
    ...
    <Text style={styles.incidentValue}>{incident.name} de {incident.city}/{incident.uf} </Text>
        ...
        {style:'currency',currency:'AOA'}).format(incident.value)}</Text>
